    ...
    .container
      ...
      .row
        .col-12.col-md-5
          ...
          p.footer-texto.mb-2
            strong Ingry Dayanna Bonilla Monzon
            br   
      ...
      .row.mt-5
        ...
        .col-12.col-md-6
          ...
          p.footer-texto                           
            strong Camilo Andrés Villamizar Lizcano
            br  
            strong Ernesto Navarro Jaimes
            br
            strong Eulises Orduz Amezquita
            br
            strong Maria Camila Ovalle Ospina 
            br
            strong Yazmin Rocio Figueroa Pacheco
            br
            span.text-small Diseño web & producción audiovisual
            br

          p.footer-texto
            strong Edgar Mauricio Cortes
            br
            strong Magdi Khalifah Gamboa
            br                
